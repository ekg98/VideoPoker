...
struct fonts {
	...
	SDL_Texture* vPokerStatusTableTexture[10][6];
	SDL_Rect vPokerStatusTableText[10][6];
	SDL_Color vPokerStatusTableTextColor[10][6];
...
struct text {
	...
	char *vPokerStatusTableString[10][6];
